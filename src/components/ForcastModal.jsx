        ...
        <>
            ...
            <Modal isOpen={isOpen} onClose={onClose} >
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <Box p={'10px'}>
                            <Box p={'5px'} bg={'#6156ed'} textAlign={'center'} borderRadius={'30px'} mb={'20px'} >
                            ...
                            <Grid templateColumns={'50% 50%'} >
                                <Box pb={'10px'} pl={'15%'}>
                                    {['Felt Temp.', 'Humidity', 'Wind', 'Pressure', 'Day Temp.', 'Evening Temp.', 'Night Temp.', 'Max Temp.', 'Min Temp.'].map((e, i) => (
                                        <Text key={i} color={'#6156ed'} fontWeight={500} mt={'15px'} fontSize={'18px'} >{e}</Text>
                                    ))}
                                </Box>
                                <Box borderRadius={'30px'} bg={'#6156ed'} pb={'10px'} pl={'15%'}>
